...
class Go1NavigationSceneCfg(NavigationSceneCfg):
    ...
    # Add height scanner for low-level policy compatibility
    # The trained Go1 flat policy expects height_scan in observations (12 dims)
    # Using 4x3 grid pattern to get exactly 12 rays
...
class Go1LowLevelObservationsCfg:
    ...
    This matches the observation space used during Go1 flat locomotion training,
    which includes height_scan (12 dims) for a total of 60 dimensions.
    """
    ...
    class PolicyCfg(ObsGroup):
        ...
        # Copy from Go1 flat locomotion observations
        ...
        # IMPORTANT: Include height_scan to match the trained policy's expected input (60 dims)
        height_scan = ObsTerm(
...
@configclass
class ObstacleObservationsCfg(ObservationsCfg):
    ...
    class PolicyCfg(ObservationsCfg.PolicyCfg):
        ...
        Extends base navigation observations with height scan for obstacle detection.
        """

        # Add height scan observation
        from isaaclab.managers import ObservationTermCfg as ObsTerm
...
class UnitreeGo1NavigationObstacleEnvCfg(UnitreeGo1NavigationEnvCfg):
    ...
    # Override observations to include height scan
