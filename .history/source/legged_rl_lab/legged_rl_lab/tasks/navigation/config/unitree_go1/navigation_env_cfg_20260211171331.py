...
class Go1NavigationSceneCfg(NavigationSceneCfg):
    ...
    height_scanner = RayCasterCfg(
        ...
        ray_alignment="yaw",
        pattern_cfg=patterns.GridPatternCfg(resolution=0.1, size=[1.2, 0.8]),  # 12x1 = 12 rays
        debug_vis=False,
...
class Go1ActionsCfg(ActionsCfg):
    ...
    pre_trained_policy_action: mdp.PreTrainedPolicyActionCfg = mdp.PreTrainedPolicyActionCfg(
        asset_name="robot",
        policy_path=GO1_FLAT_POLICY_PATH,  # policy path for the pre-trained low-level locomotion policy
