...
class ActionsCfg:
    ...
    pre_trained_policy_action: mdp.PreTrainedPolicyActionCfg = mdp.PreTrainedPolicyActionCfg(
        ...
        # NOTE: Update this path to your latest trained Go1 flat locomotion policy
        policy_path="logs/rsl_rl/unitree_go1_flat/2026-02-01_18-43-20/exported/policy.pt",
