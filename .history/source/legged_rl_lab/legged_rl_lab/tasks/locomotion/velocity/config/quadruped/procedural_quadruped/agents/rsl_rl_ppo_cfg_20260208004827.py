...
@configclass
class PreGenQuadrupedFlatPPORunnerCfg(ProceduralQuadrupedBasePPORunnerCfg):
    """PPO runner configuration for pre-generated quadruped on flat terrain.
    
    Uses the same network architecture as the procedural version.
    Observation dim is slightly larger (+7 for morphology params).
    """
    
    def __post_init__(self):
        super().__post_init__()
        self.experiment_name = "pregen_quadruped_flat"
        self.max_iterations = 20000
