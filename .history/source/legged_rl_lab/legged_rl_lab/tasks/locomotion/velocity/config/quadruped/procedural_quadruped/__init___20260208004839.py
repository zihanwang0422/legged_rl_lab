...
##
# Pre-Generated USD environments
# These use offline-generated USD files + morphology observation injection
##

# Pre-generated flat terrain environment
gym.register(
    id="LeggedRLLab-Isaac-Velocity-Flat-PreGen-Quadruped-v0",
    entry_point=_PROCEDURAL_ENV_ENTRY_POINT,
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.pregen_env_cfg:PreGenQuadrupedFlatEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:PreGenQuadrupedFlatPPORunnerCfg",
    },
)

# Pre-generated flat terrain play environment
gym.register(
    id="LeggedRLLab-Isaac-Velocity-Flat-PreGen-Quadruped-Play-v0",
    entry_point=_PROCEDURAL_ENV_ENTRY_POINT,
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.pregen_env_cfg:PreGenQuadrupedFlatEnvCfg_PLAY",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:PreGenQuadrupedFlatPPORunnerCfg",
    },
)
