...
class ProceduralQuadrupedFlatEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # ===== Base Rewards =====
        # Tracking rewards - 与 Go1 相同
        self.rewards.track_lin_vel_xy_exp.weight = 2.5
        self.rewards.track_ang_vel_z_exp.weight = 0.75  # 从 1.0 降低，匹配 Go1
        
        # Base penalties
        self.rewards.lin_vel_z_l2 = None
        self.rewards.ang_vel_xy_l2.weight = -0.1
        self.rewards.flat_orientation_l2.weight = -2.0  # 从 -3.0 降低，给异构机器人更多自由度
        self.rewards.base_height_l2.weight = -1.0  # 保持较小，因为不同形态的最优高度不同
        self.rewards.base_height_l2.params["target_height"] = 0.35  # 保持自适应高度
        self.rewards.body_lin_acc_l2 = None
        self.rewards.base_ang_vel_x_l2 = None
        
        # ===== Joint Rewards =====
        self.rewards.joint_torques_l2.weight = -2.5e-5  # 匹配 Go1
        self.rewards.joint_vel_l1 = None
        self.rewards.joint_vel_l2.weight = -0.01  # 启用，限制关节速度
        self.rewards.joint_acc_l2.weight = -2.0e-7  # 匹配 Go1
        self.rewards.joint_deviation_l1 = None
        self.rewards.joint_pos_limits.weight = -1.0  # 匹配 Go1
        self.rewards.joint_vel_limits = None
        self.rewards.applied_torque_limits = None
        self.rewards.joint_power = None
        
        # Action penalties - 匹配 Go1
        self.rewards.action_rate_l2.weight = -0.01
        self.rewards.action_l2 = None
        
        # ===== Contact Rewards =====
        # Undesired contacts - 匹配 Go1
        ...
        # Feet rewards - 匹配 Go1 的改进配置
        self.rewards.feet_air_time.weight = 0.5  # 大幅增加，鼓励抬腿
        self.rewards.feet_air_time.params["sensor_cfg"].body_names = ".*_foot"
        self.rewards.feet_air_time.params["threshold"] = 0.4
        self.rewards.feet_height = None
        self.rewards.feet_slide.weight = -0.1  # 启用，惩罚滑动
