...
class UnitreeGo1FootstandEnvCfg(LocomotionVelocityRoughEnvCfg):
    def __post_init__(self):
        ...
        if hand_stand_type == "rear":
            ...
            joint_symmetry_weight = -1.0
            action_symmetry_weight = -0.5
        ...
        # 5. Symmetry Rewards - ensure left-right symmetry for both front and rear legs
        self.rewards.joint_symmetry_l2.weight = joint_symmetry_weight
        self.rewards.joint_symmetry_l2.params["mirror_joints"] = [
            [["FL_hip_joint"], ["FR_hip_joint"]],    # Front left-right hip symmetry
            [["FL_thigh_joint"], ["FR_thigh_joint"]], # Front left-right thigh symmetry
            [["FL_calf_joint"], ["FR_calf_joint"]],   # Front left-right calf symmetry
            [["RL_hip_joint"], ["RR_hip_joint"]],     # Rear left-right hip symmetry
            [["RL_thigh_joint"], ["RR_thigh_joint"]], # Rear left-right thigh symmetry
            [["RL_calf_joint"], ["RR_calf_joint"]],   # Rear left-right calf symmetry
        ]
