...
class UnitreeGo1FlatEnvCfg(LocomotionVelocityRoughEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.ang_vel_xy_l2.weight = -0.05  # 减小惩罚，避免过度约束
        self.rewards.flat_orientation_l2.weight = -2.0  # 减小，避免过度僵硬
        self.rewards.base_height_l2.weight = -1.0  # 减小，给机器人更多自由度
        ...
        # ===== Joint Rewards =====
        self.rewards.joint_torques_l2.weight = -0.0001  # 减小，避免过度限制力矩
        self.rewards.joint_vel_l1 = None
        self.rewards.joint_vel_l2.weight = -0.01  # 启用，限制关节速度
        self.rewards.joint_acc_l2.weight = -1.0e-7  # 减小，避免过度约束加速度
        ...
        # Action penalties - 关键：防止抖动
        self.rewards.action_rate_l2.weight = -0.01  # 启用动作平滑约束
