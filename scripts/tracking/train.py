"""Script to train RL agent with RSL-RL for motion tracking tasks."""
...
parser = argparse.ArgumentParser(description="Train a motion tracking RL agent with RSL-RL.")
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    # set the motion file from CLI argument
    ...
    # create runner from rsl-rl (using MotionOnPolicyRunner for auto ONNX export)
    runner = MotionOnPolicyRunner(env, agent_cfg.to_dict(), log_dir=log_dir, device=agent_cfg.device)
