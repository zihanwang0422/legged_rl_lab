"""Script to play a checkpoint of an RL agent for motion tracking tasks."""
...
parser = argparse.ArgumentParser(description="Play a motion tracking RL agent with RSL-RL.")
