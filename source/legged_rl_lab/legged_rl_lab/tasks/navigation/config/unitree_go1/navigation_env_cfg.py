...
# The policy should be trained with height_scan enabled (208 dims total)
...
class Go1LowLevelObservationsCfg:
    ...
    With height_scan (208 dims total):
    - base_lin_vel: 3 dims
    - base_ang_vel: 3 dims  
    ...
    - height_scan: 160 dims (16x10 grid)
    Total: 208 dims
    
    Without height_scan (48 dims total) - for old policies:
    Remove height_scan observation below and total will be 48 dims
    """
    ...
    class PolicyCfg(ObsGroup):
        ...
        # Base observations (48 dims without height_scan)
        ...
        # Height scan observation (160 dims) - comment out for old 48-dim policies
        # TODO: Uncomment after training new policy with height_scan
        # height_scan = ObsTerm(
