...
AME_PARKOUR_TERRAINS_CFG = TerrainGeneratorCfg(
    ...
    sub_terrains={
        ...
        "stakes_easy": HfDoubleColumnStakesTerrainCfg(
            proportion=0.16,
            stake_height_max=0.02,
            stake_side_range=(0.20, 0.35),
            stake_gap_range=(0.12, 0.30),
            column_gap_range=(0.1, 0.1),
            column_jitter=0.0,
            holes_depth=-2.0,
            platform_width=2.0,
        ...
        "stakes_alternate": HfAlternateColumnStakesTerrainCfg(
            ...
            stake_height_max=0.02,
            stake_side_range=(0.20, 0.35),
            stake_gap_range=(0.08, 0.22),
            column_gap_range=(0.0, 0.25),
            column_jitter=0.0,
            holes_depth=-2.0,
            platform_width=2.0,
            border_width=0.25,
        ...
        "stonebridge": HfStonesBridgeTerrainCfg(
            ...
            border_width=0.25,
            holes_depth=-2.0,
            stone_height_max=0.02,
            stone_width_range=(0.25, 0.35),
            stone_distance_range=(0.25, 0.45),
            stone_length_range=(0.6, 1.0),
            stone_lateral_distance_range=(0.0, 0.0),
        ),
    },
)
"""Reduced parkour terrain set for AME attention: stairs plus AME custom obstacles."""
